...
<section class="whyus-section">
    <div class="whyus-container">
        ...
        <div class="whyus-header">
            ...
            <h2>Why Choose Us?</h2>
            <p>Discover the values, qualities, and features that make us stand out from the rest and deliver exceptional results.</p>
        </div>
        ...
        <% } else { %>
            <div class="whyus-empty">
                ...
                <p>No feature showcase items are currently set. Admins can add items from the dashboard.</p>
            </div>
        <% } %>
